...
window.addEventListener('DOMContentLoaded', () => {
  ...
  const categorySwiper = new swiper__WEBPACK_IMPORTED_MODULE_0__["default"]('.products-category__carousel', {
    ...
    on: {
      slideChange: function (swiper) {
        ...
        if (swiper.activeIndex >= 1 && swiper.activeIndex <= items.length - 1) {
          if (swiper.previousIndex > swiper.activeIndex && items.length - swiper.previousIndex > 2) {
            //prev
